defmodule LiveViewTestWeb.MinioSigning do
  ...
  defp pre_signed_url(method, config, date_time) do
    ...
    request_query =
      %{
        ...
        "X-Amz-Credential" => uriEscape(get_credential(config.access_key_id, config.region, date_time)),
    ...
    canonical_request = get_canonical_request(method, path, headers, signed_header, request_resource, request_query) |> IO.inspect()
  ...
  @spec get_canonical_request(String.t, String.t, List.t(), String.t, String.t, String.t) :: String.t
  defp get_canonical_request(method, path, headers, signedHeader, request_resource, request_query) do
